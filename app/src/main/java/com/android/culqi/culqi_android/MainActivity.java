...
public class MainActivity extends AppCompatActivity {
    ...
    TextView txtcardnumber, txtcvv, txtmonth, txtyear, txtname, txtlastname, txtemail, kind_card, result;
    Button btnTry;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnTry.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                Log.d("", "pagando.......");
                progress.show();
                token.createToken(getApplicationContext(), progress, "pk_test_vzMuTHoueOMlgUPj",result, txtcardnumber.getText().toString(),
                        "PEN", txtcvv.getText().toString(), 9, 2020, txtlastname.getText().toString(),
                        txtemail.getText().toString(),txtname.getText().toString());
                //createToken("pk_test_vzMuTHoueOMlgUPj");
            }
        });
